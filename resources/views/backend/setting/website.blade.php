...
<div class="row">
 ...
 <div class="form-group">
    <label for="exampleTextarea1">Address Español</label>
    <textarea class="form-control" name="address_es" id="summernote1">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1"> Phone Español</label>
    <input type="text" class="form-control" name="phone_es"  value="{{ $websitesetting->phone_es }}">
     </div>
