...
<div class="col-12 grid-margin stretch-card">
  ...
  @csrf
    ...
    <div class="row">
     ...
     <div class="form-group col-md-6">
      <label for="exampleInputName1">Título Español</label>
      <input type="text" class="form-control" id="exampleInputName1" name="title_es">
    </div>
 ...
 <div class="row">
  ...
  <option value="{{ $row->id }}">{{ $row->category_es  }}</option>
                @endforeach
                        </select>
    </div>
 ...
 <div class="row">
  ...
  <option value="{{ $row->id }}">{{ $row-> distrito_es  }}</option>
                @endforeach
                        </select>
    </div>
...
<div class="row">
     ...
     <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="exampleInputName1" name="tags_es">
    </div>
 ...
 <div class="form-group">
    ...
    <textarea class="form-control" name="details_es" id="summernote1"></textarea>
                      </div>
