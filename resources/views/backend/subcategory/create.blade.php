...
<form class="forms-sample" method="POST" action="{{ route('store.subcategory') }}">
  ...
  <div class="form-group">
    <label for="exampleInputEmail1">SubCategory Español</label>
    <input type="text" class="form-control" name="subcategory_es"  placeholder="SubCategory Español">
     @error('subcategory_es')
