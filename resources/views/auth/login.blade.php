 ...
 <input type="email"  id="email" name="email" class="form-control p_input">
    ...
    <input type="password" id="password" name="password" class="form-control p_input">
                  ...
                  <div class="form-group d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('password.request') }}" class="forgot-pass">¿Se te olvidó tu contraseña?</a>
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn btn-primary btn-block enter-btn">Iniciar sesión</button>
                  </div>
                  <p class="sign-up">¿No tienes una cuenta?<a href="{{ route('register') }}"> Regístrate</a></p>
                </form>
              </div>
            </div>
          </div>
