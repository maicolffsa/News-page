...
<li class="dropdown">
	<a href="{{ URL::to('catpost/'.$row->id.'/'.$row->category_es) }}" > 
		@if(session()->get('lang')== 'spanish')
		{{ $row->category_es }}
		@else
		{{ $row->category_es }}
...
<ul class="dropdown-menu">
	...
	<li><a href="{{ URL::to('subcatpost/'.$row->id.'/'.$row->subcategory_es) }}">
		@if(session()->get('lang')== 'spanish')
		{{ $row->subcategory_es }}
		@else
		{{ $row->subcategory_es }}
...
@if(session()->get('lang') == 'spanish')
<li class="version"><a href="{{ route('lang.spanish') }}"><B>Español</B></a></li>&nbsp;&nbsp;&nbsp;
@else
<li class="version"><a href="{{ route('lang.spanish') }}"><B>Español</B></a></li>&nbsp;&nbsp;&nbsp;
@endif
